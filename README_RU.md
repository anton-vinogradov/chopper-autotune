...
- **Tune A** / **Tune B** — затюнить один мотор и напечатать рекомендацию (на CoreXY `stepper_x`/`stepper_y` — это два мотора A и B, а не оси X/Y; на других кинематиках кнопки подписаны **Tune X** / **Tune Y**);
