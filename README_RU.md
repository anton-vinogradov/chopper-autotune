...
Текущее ограничение: поиск по регистрам — простой перебор сетки; умные стратегии (покоординатный спуск, Optuna, ранний abort) — следующие пункты дорожной карты.
...
CHOPPER_COLLECT SPEED=55             ; 2. перебор сетки на резонансной скорости (долго)
