...
- **Belts** — measure belt tension by plucking: follow the display, pluck each belt left and right of the head; the accelerometer hears the tension and the two sides cross-check each other;
