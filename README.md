...
- Klipper + Moonraker (Mainsail, Fluidd or any other frontend). [Kalico](https://github.com/KalicoCrew/kalico) works too, including its `limited_corexy` kinematics and `[resonance_tester] accel_chips`.
...
- **An accelerometer on the toolhead** — the measuring instrument of the whole tool:
  - any chip supported by Klipper's resonance stack works: ADXL345 (the classic), LIS2DW, LIS3DH, the MPU-9250 family, ICM-20948, BMI160; USB sticks (KUSBA, FYSETC PIS) and CAN toolhead boards with an onboard chip (EBB36/42, SB2209, …) count too;
