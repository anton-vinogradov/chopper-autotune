...
# accelerometer modules, and Beacon's probe module, for tests/test_klipper_contract.py.
# The GPL sources are downloaded, never committed; pinned revisions keep the contract
# reproducible.
set -euo pipefail
